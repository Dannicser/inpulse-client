        ...
        <Layout classes={`xl:mx-[7.5rem] lg:mx-[5.5rem] md:mx-[3.5rem] sm:mx-[1rem] xs:mx-[1rem] us:mx-[1.875rem] mt-20`}>
          <div className={s.footer_top_grid}>
            ...
            <div className={s.social}>
              ...
              <div className={s.social_text} >Shall we tell an <br/> exciting story together?</div>
          ...
          <div className={s.footer_bottom_grid}>
            ...
            <nav className={s.nav}>
              <a className={s.nav_item} href="#">Home</a>
              <a className={s.nav_item} href="#">What are we</a>
              <a className={s.nav_item} href="#">For Who?</a>
              <a className={s.nav_item} href="#">Contacts</a>
            </nav>
